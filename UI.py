...
class Boycott:
    ...
    '''  
    fouction updtae freams from the cmera
    ...
    '''  
    fouction to open detected image
    ...
    def open_image(self):
        ...
        if file_path:
            self.image_path = file_path  # تخزين مسار الصورة في متغير
            detect_image,path=self.detector.imageDetect(self.image_path)

            full_path_detect_image=path +'\\'+ detect_image
